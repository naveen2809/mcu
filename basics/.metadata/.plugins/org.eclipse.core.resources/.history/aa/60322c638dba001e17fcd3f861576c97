...
int main(void)
{
	...
	char message[] = "Testing UART Interrupt Driver With Synchronization Support: Hello World!!!\r\n";
	...
	USART_SendData_Interrupt(&Test_USART,message1,strlen(message1),USART2_IRQ_NUM);

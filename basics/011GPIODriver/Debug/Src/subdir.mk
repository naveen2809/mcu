...
C_DEPS += \
./Src/combined_calculator_clock_temp.d \
./Src/syscalls.d \
./Src/sysmem.d 
...
clean-Src:
	-$(RM) ./Src/combined_calculator_clock_temp.d ./Src/combined_calculator_clock_temp.o ./Src/combined_calculator_clock_temp.su ./Src/syscalls.d ./Src/syscalls.o ./Src/syscalls.su ./Src/sysmem.d ./Src/sysmem.o ./Src/sysmem.su

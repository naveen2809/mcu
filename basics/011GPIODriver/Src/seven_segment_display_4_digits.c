...
int main(void)
{
	...
	//GPIO Configuration for the Individual Digit Enable Pins (Anodes)
	EnablePeriClk(GPIOC);
	...
	//Turning on the required Digits (Anodes)
	GPIOWritePin(GPIOC, GPIO_DIGIT_1,GPIO_HIGH);
	GPIOWritePin(GPIOC, GPIO_DIGIT_2,GPIO_HIGH);
	GPIOWritePin(GPIOC, GPIO_DIGIT_3,GPIO_HIGH);
	GPIOWritePin(GPIOC, GPIO_DIGIT_4,GPIO_HIGH);
